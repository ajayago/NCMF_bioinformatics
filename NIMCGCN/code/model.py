...
class Model(nn.Module):
    ...
    def forward(self, input):
        ...
        self.md_recon = x.mm(y.t())
        self.protein_repr = x
        self.drug_repr = y

        return x.mm(y.t())

    def predict_score(self, idx):
        """
        idx - tuple containing index of cell whose value is being predicted
        """
        return self.md_recon[idx[0]][idx[1]]

    def get_repr(self):
        return self.protein_repr, self.drug_repr
