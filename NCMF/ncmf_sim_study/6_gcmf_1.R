...
base_dir_gcmf <- paste(base_dir,"gcmf/",sep="")
base_dir_gcmf_out <- paste(base_dir_gcmf,"out/",sep="")

dir.create(base_dir_gcmf_out)
...
for(dataset_name in list('dt1', 'ds1', 'ds2', 'ds3', 'dn1', 'dn2', 'dn3')){
  ...
  out_dir <- paste(base_dir_gcmf_out,dataset_name,'/',sep="")
