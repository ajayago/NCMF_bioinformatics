...
# Dr_Di = np.random.rand(7,5)
# P_Dr = np.random.rand(10,7)   
# P_Di = np.random.rand(10,5)
# #0: patients, 1: drugs, 2: diseases
...
# ns = [10,7,5] #number of objects in each entity
# cs = [2,2,2] #factorization ranks

# G, S = dfmf(R, Theta, ns, cs)
# print('G:')
# print(G)
# print('S:')
# print(S)