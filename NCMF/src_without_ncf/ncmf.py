...
from src_without_ncf.sample import *
#from src_without_ncf.evaluate import *
from src_without_ncf.link_prediction import *
...
class ncmf():
    ...
    def fit(self):
        print('NCMF without neural network for matrix reconstruction')
        set_seed(self.seed)
