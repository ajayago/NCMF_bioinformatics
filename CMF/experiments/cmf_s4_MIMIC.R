...
data_folder <- '../../datasets/CMF/MIMIC/sampled4/'
test_link_file <- 'sampled4_link.dat.test' # TODO
emb_file <- 'cmf_s4_MIMIC_emb.dat' # TODO
...
D <- c(5911, 1321, 596) # node count for Polypharmacy dataset
inds <- matrix(0, nrow=3, ncol=2) # entity
inds[1,] <- c(1, 2)
inds[2,] <- c(2, 3)
inds[3,] <- c(3, 1) # only three matrices exist between the drug-gene datasets
#inds[4,] <- c(3, 1)
#inds[5,] <- c(3, 2)
#inds[6,] <- c(3, 3)
#inds[7,] <- c(3, 4)
