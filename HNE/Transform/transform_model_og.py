...
data_folder, model_folder = '../../data-fusion/datasets', '../Model'
prefix = 'sampled5_'
node_file, link_file, label_file = f'{prefix}node.dat', f'{prefix}link.dat', f'{prefix}label.dat'
info_file, meta_file = f'{prefix}info.dat', f'{prefix}meta.dat'
