...
dataset='Polypharmacy' # choose from 'DBLP', 'Yelp', 'Freebase', and 'PubMed'
model='HEER' # choose from 'metapath2vec-ESim', 'PTE', 'HIN2Vec', 'AspEm', 'HEER', 'R-GCN', 'HAN', 'HGT', 'TransE', 'DistMult', and 'ConvE'
