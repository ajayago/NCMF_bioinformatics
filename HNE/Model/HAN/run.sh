...
meta="0" # "1,2,4,8" # Choose the meta-paths used for training. Suppose the targeting node type is 1 and link type 1 is between node type 0 and 1, then meta="1" means that we use meta-paths "101".
size=50
nhead="8"
dropout=0.4
neigh_por=0.6
